        ...
        $("#loginForm").on("submit", function(e){
            ...
            firebase.auth().signInWithEmailAndPassword(email, password)
                .then((userCredential) => {
                    ...
                    $("#getBackupButton").css("visibility", "visible");
...
function downloadDatabase() {
    let backup = {}
    firebase.database().ref("books").once("value", function(snap){
        backup["books"] = JSON.parse(JSON.stringify(snap))
        // Creates a temporary HTML element
